...
var AddonModResourceIndexPage = /** @class */ (function () {
    ...
    AddonModResourceIndexPage = __decorate([
        Object(__WEBPACK_IMPORTED_MODULE_0__angular_core__["m" /* Component */])({
            selector: 'page-addon-mod-resource-index',template:/*ion-inline-start:"C:\Users\Josiah\Documents\Code\quikitech\e4e\mobileapp\src\addon\mod\resource\pages\index\index.html"*/'<ion-header>\n\n    <ion-navbar core-back-button>\n\n        <ion-title><core-format-text [text]="title"></core-format-text></ion-title>\n\n\n\n        <ion-buttons end>\n\n            <!-- The buttons defined by the component will be added in here. -->\n\n        </ion-buttons>\n\n    </ion-navbar>\n\n</ion-header>\n\n<ion-content>\n\n    <ion-refresher [enabled]="resourceComponent.loaded && resourceComponent.mode == \'external\'" (ionRefresh)="resourceComponent.doRefresh($event)">\n\n        <ion-refresher-content pullingText="{{ \'core.pulltorefresh\' | translate }}"></ion-refresher-content>\n\n    </ion-refresher>\n\n\n\n    <addon-mod-resource-index [module]="module" [courseId]="courseId" (dataRetrieved)="updateData($event)"></addon-mod-resource-index>\n\n</ion-content>\n\n'/*ion-inline-end:"C:\Users\Josiah\Documents\Code\quikitech\e4e\mobileapp\src\addon\mod\resource\pages\index\index.html"*/,
        }),
